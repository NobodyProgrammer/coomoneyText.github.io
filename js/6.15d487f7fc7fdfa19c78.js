...
// EXTERNAL MODULE: ./src/firebase.js + 1 modules
var firebase = __webpack_require__("MhFl");

// EXTERNAL MODULE: ./node_modules/vuex/dist/vuex.esm.js
var vuex_esm = __webpack_require__("NYxO");

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/card-game/RandomChatroom.vue
...
/* harmony default export */ var RandomChatroom = ({
  name: 'RandomChatroom',
  props: {
    roomId: String,
    targetId: String
  ...
  data: function data() {
    return {
      ...
      title: '讀取中',
      messages: [],
      rooms: firebase["a" /* db */].ref('rooms').child(this.roomId),
      modal: {
        isDisplay: false,
        okText: '',
        cancelText: '',
      ...
      return regenerator_default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              // countdown 5 mins, and ask if add each other after countdown
              setInterval(function () {
                _this.modal = extends_default()({}, _this.modal, {
                  isDisplay: true,
                  okText: '確定',
                  cancelText: '取消',
                  content: '你想要加對方為好友嗎？',
                      ...
                      return regenerator_default.a.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              _this.modal.isDisplay = false;
                              _context.next = 3;
                              return _this.addFriends([_this.targetUser]);
              ...
              _this.rooms.child('messages').on('value', function (snapshot) {
                ...
                _this.messages = [].concat(toConsumableArray_default()(_this.messages), toConsumableArray_default()(messages.slice(_this.messages.length, messages.length)));
              });

              _context2.next = 4;
              return _this.$store.dispatch('getUserInfo', _this.targetId);

            case 4:
              targetUser = _context2.sent;

              targetUser.avatar = __webpack_require__("EFPb")("./" + targetUser.gender + '-' + targetUser.animal + '-' + targetUser.type + '.svg');

              _this.targetUser = targetUser;
              _this.title = _this.targetUser.nickname;
  ...
  methods: extends_default()({}, Object(vuex_esm["b" /* mapActions */])(['addFriends']), {
    sendMessageHandler: function sendMessageHandler() {
      var _this2 = this;
      ...
      this.rooms.child('messages').transaction(function (messages) {
        if (messages) {
          messages.push(wrappedMessage);
          return messages;
        }
        return [wrappedMessage];
      }, function (error, success) {
        if (!success) {
          _this2.modal = extends_default()({}, _this2.modal, {
            isDisplay: true,
            okText: '確定',
            content: '傳送訊息失敗！請稍後試試！',
            handler: function handler() {
    ...
    isShowAvatar: function isShowAvatar(index) {
      return index === 0 || this.messages[index - 1].from !== this.messages[index].from;
    }
  })
});
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-0094e0ab","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/card-game/RandomChatroom.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header',{attrs:{"title":_vm.title},on:{"back":function($event){return _vm.$router.go(-1)}}}),_vm._v(" "),_c('transition-group',{directives:[{name:"chat-scroll",rawName:"v-chat-scroll",value:({ always: false, smooth: false }),expression:"{ always: false, smooth: false }"}],ref:"messageContainer",staticClass:"chat-messsage-list",attrs:{"tag":"div","name":"chat-message-transition"}},_vm._l((_vm.messages),function(message,index){return _c('div',{key:("chatroom-message-" + index),class:{ 'chat-avatar-message': _vm.isShowAvatar(index) }},[(_vm.isShowAvatar(index) && message.from !== _vm.user.gid)?_c('div',{staticClass:"chat-message-avatar-container"},[_c('img',{attrs:{"src":_vm.targetUser.avatar}})]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"chat-message-content-container"},[_c('span',{class:{
          'user-message': message.from === _vm.user.gid,
          'target-user-message': message.from !== _vm.user.gid,
          'target-user-message-correction': message.from !== _vm.user.gid && !_vm.isShowAvatar(index) }},[_vm._v(" "+_vm._s(message.content)+" ")])])])}),0),_vm._v(" "),_c('div',{staticClass:"chat-input"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.inputMessage),expression:"inputMessage"}],ref:"input",domProps:{"value":(_vm.inputMessage)},on:{"focus":function($event){_vm.$refs.messageContainer.scrollTop = _vm.$refs.messageContainer.scrollHeight},"input":function($event){if($event.target.composing){ return; }_vm.inputMessage=$event.target.value}}}),_vm._v(" "),_c('button',{staticClass:"ripple",on:{"click":_vm.sendMessageHandler}})]),_vm._v(" "),_c('SlotModal',{attrs:{"show":_vm.modal.isDisplay,"okText":_vm.modal.okText,"cancelText":_vm.modal.cancelText},on:{"ok":_vm.modal.handler,"cancel":function($event){_vm.modal.isDisplay = false}}},[_c('span',{domProps:{"innerHTML":_vm._s(_vm.modal.content)}})])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var card_game_RandomChatroom = (esExports);
// CONCATENATED MODULE: ./src/components/card-game/RandomChatroom.vue
function injectStyle (ssrContext) {
  __webpack_require__("UEJI")
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-0094e0ab"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  RandomChatroom,
  card_game_RandomChatroom,
...
/* harmony default export */ var components_card_game_RandomChatroom = __webpack_exports__["default"] = (Component.exports);
...
var firebaseApp = index_cjs_default.a.initializeApp({
  apiKey: "AIzaSyApCjOJbHxSJnErpdVGZKCXR9MR9tscJCo",
  authDomain: "ainimal-1533547473262.firebaseapp.com",
  databaseURL: "https://ainimal-1533547473262.firebaseio.com",
  projectId: "ainimal-1533547473262",
  storageBucket: "ainimal-1533547473262.appspot.com",
  messagingSenderId: "83977346669"
});
...
var tslib = __webpack_require__("l7Gt");
var util = __webpack_require__("Pxmi");
var component = __webpack_require__("l0SK");
var logger$1 = __webpack_require__("fjI4");
...
var tslib = __webpack_require__("ZKbr");
...
var tslib = __webpack_require__("QJXb");
var util = __webpack_require__("Pxmi");
var logger$1 = __webpack_require__("fjI4");
var component = __webpack_require__("l0SK");
    ...
    WebSocketConnection.prototype.open = function (onMessage, onDisconnect) {
        ...
        try {
            if (util.isNodeSdk()) {
                ...
                var env = Object({"NODE_ENV":"development","API_URL":"https://devel.ainimal.io/api","WS_URL":"wss://devel.ainimal.io/ws/chat/"});
...
var RepoManager = /** @class */ (function () {
    ...
    RepoManager.prototype.databaseFromApp = function (app, authProvider, url) {
        ...
        if (typeof process !== 'undefined') {
            dbEmulatorHost = Object({"NODE_ENV":"development","API_URL":"https://devel.ainimal.io/api","WS_URL":"wss://devel.ainimal.io/ws/chat/"})[FIREBASE_DATABASE_EMULATOR_HOST_VAR];
        }
        if (dbEmulatorHost) {
            isEmulator = true;
...
var tslib = __webpack_require__("8tJR");
var util = __webpack_require__("Pxmi");
...
//# sourceMappingURL=6.15d487f7fc7fdfa19c78.js.map